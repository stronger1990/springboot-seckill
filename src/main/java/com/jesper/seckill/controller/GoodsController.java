...
public class GoodsController {
	...
	/**
	 * 商品列表页面 QPS:433 1000 * 10
	 * 如果是写produces = {"application/xml;charset=UTF-8"}，就是返回的数据是这个编码格式的，防止中文乱码。
	 * 这里写的是produces = "text/html"，表示输出的是HTML文本。
	 * 
	 * 其实这里是通过SpringWebContext渲染HTML数据才输出HTML文本，还不如直接输出/goods_list.html让其自动渲染呢
	 */
